 ...
 * @package dompdf
 */
class List_Bullet_Image extends List_Bullet
{
    /**
    ...
    public function __construct(Frame $frame, Dompdf $dompdf)
    {
        ...
        $frame->get_node()->set_attribute('src', $url);
    ...
    public function get_margin_height(): float
    {
        ...
        $font_height = $font_metrics->get_font_height($font, $size);
        $baseline = $font_metrics->get_font_baseline($font, $size);
        ...
        return $f * ($font_height - $baseline) + $this->_height;
    }
    /**
     * Return image url
     *
