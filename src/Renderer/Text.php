...
class Text extends Abstract_Renderer
{
    ...
    public function render(Frame $frame): void
    {
        ...
        $frame_font_size = $frame->get_dompdf()->get_font_metrics()->get_font_height($font, $size);
        ...
        if ($options->get_debug_layout() && $options->get_debug_layout_lines()) {
            ...
            $this->debug_layout([$x, $y, $text_width, $frame_font_size], 'orange', [0.5, 0.5]);
        }
    }
}